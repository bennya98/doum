...
@add_arg_table! s begin
    ...
    default = "C:/Users/benny/PycharmProjects/doum/MTCGP/cfg/gym.yaml"
    "--scenario"
    help = "scenario"
    default = "C:/Users/benny/PycharmProjects/doum/scenarios/defend_the_center.cfg"
    "--map"
    help = "map"
    default = "map01"
    "--seed"
...
function play_vizdoom(ind::MTCGPInd; seed=0, max_frames=10000)
    game = get_game()
    run_counter = 0
    reward = 0.0
    frames = 0
